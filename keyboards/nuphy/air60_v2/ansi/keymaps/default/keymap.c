...
[0] = LAYOUT(
	...
	KC_CAPS,            LT(2, KC_A),   	KC_S,   	KC_D,  		KC_F,   	KC_G,   	KC_H,   	KC_J,   	KC_K,   	KC_L,  		KC_SCLN,	LT(3, KC_QUOT), 	        KC_ENT,
...
[2] = LAYOUT(
	...
	_______, 	_______,   	_______,   	_______,  	_______,   	_______,   	KC_LEFT,   	KC_DOWN,   	KC_UP,   	KC_DOWN,  	_______,   	_______,	            _______,
	_______,	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,	_______, 	_______,    _______,
